...
@slot('title') Tambah Outlet @endslot
@endcomponent
                ...
                <div class="p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 overflow-hidden">
                            <h5 class="font-size-16 mb-1">Tambah Outlet</h5>
                            <p class="text-muted text-truncate mb-0">Form ini digunakan untuk menambah data outlet.</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <select name="id_zona" id="id_zona" class="form-select" required>
                                    ...
                                    <option value="{{ $id }}" {{ old('id_zona')==$id ? 'selected' : '' }}>{{ $name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
...
@section('script')
<script>
    function previewImage(containerSelector, file) {
        ...
        if (file && file.type.startsWith('image/')) {
            ...
            reader.onload = function (e) {
                ...
                img.style.maxWidth = '400px'; // Set a max width
                img.style.height = 'auto'; // Maintain aspect ratio
                container.appendChild(img);
            };
            reader.readAsDataURL(file);
        } else {
            container.innerHTML = '<p class="text-danger">File bukan gambar atau tidak valid.</p>';
        }
    }
</script>
...
<script>
   document.addEventListener('DOMContentLoaded', function () {
        ...
        const defaultLat = -3.9862;
        const defaultLon = 122.5144;
        ...
        // Update map with new coordinates when input fields change
