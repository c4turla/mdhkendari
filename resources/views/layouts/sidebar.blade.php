            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{url('outlets')}}">List Outlet</a></li>
                        <li><a href="{{url('outlets/show')}}">Posisi Outlet</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{url('barang')}}">List Produk</a></li>
                        <li><a href="{{url('harga_barang')}}">Harga Per Zona</a></li>
                    </ul>
                </li>

                <li class="menu-title">STOK BARANG</li>
                <li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="uil-brightness-minus"></i>
                        <span>Barang Keluar</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{url('faktur_penjualan')}}">Faktur Penjualan</a></li>
                        <li><a href="{{url('surat_jalan')}}">Surat Jalan</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{url('barang_return')}}">
                        <i class="uil-store"></i>
